...
use Devnation\App\Controllers\ControllerBase;
...
class UserController extends ControllerBase {
    ...
    public function indexAction()
    {
        if(true === $this->auth->isUserSignedIn()) {
            ...
            $this->response->redirect(['for' => 'profile', 'action' => 'profile']);
        } else {
            $this->response->redirect(['for' => 'login', 'action' => 'login']);
        }
    }
    ...
    public function loginAction()
    {
        if(true === $this->auth->isUserSignedIn())
        {
            $this->response->redirect(['for' => 'home', 'action' => 'home']);
        }
